...
class NodeMap {
  ...
  nodeId(node) {
      ...
      if (!id)
          id = node[this.ID_PROP] = this.nextId_++;
      return id;
  }
...
class NodeChange {
    ...
    constructor(node, childList=false, attributes=false, characterData=false,
      oldParentNode=null, added=false, attributeOldValues=null, characterDataOldValue=null) {
    this.node = node;
